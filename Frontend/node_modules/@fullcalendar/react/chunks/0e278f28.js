...
import { B as BaseComponent, C as ContentContainer, r as renderText, m as memoize, a as generateClassName, g as getIsHeightAuto } from './8563f14c.js';
import { f as findWeekdayText, a as findDayNumberText, b as buildNavLinkAttrs, W as WEEKDAY_ONLY_FORMAT, F as FULL_DATE_FORMAT, S as StandardEvent, g as getDateMeta, c as buildDateStr, D as DateComponent, V as ViewContainer, d as Scroller, N as NowTimer } from './bdcb9f0b.js';
import { c as createFormatter, ac as sortEventSegs, ad as getEventRangeMeta, s as sliceEventStore } from './1b9384f3.js';
...
class ListDay extends BaseComponent {
    ...
    render() {
        ...
        return (jsxs("div", { role: 'listitem', "aria-label": fullDateStr, className: generateClassName(options.listDayClass, listDayData), children: [jsx(ListDayHeader, { dayDate: props.dayDate, dateMeta: dateMeta, forPrint: props.forPrint }), jsx("div", { role: 'list', "aria-label": options.eventsHint, className: joinClassNames(generateClassName(options.listDayBodyClass, listDayEventsData), classNames.flexCol), children: segs.map((seg, index) => {
                        ...
                        return (jsx(ListEvent, { eventRange: seg.eventRange, slicedStart: seg.slicedStart, slicedEnd: seg.slicedEnd, isStart: seg.isStart, isEnd: seg.isEnd, isFirst: isFirst, isLast: isLast, isDragging: false, isResizing: false, isMirror: false, isSelected: false, ...getEventRangeMeta(seg.eventRange, todayRange, nowDate, props.nowMs) }, key));
                    }) })] }));
    }
}
...
class ListView extends DateComponent {
    ...
    renderSegList(allSegs, dayDates) {
        ...
        return (jsx("div", { role: "list", "aria-labelledby": this.props.labelId, "aria-label": this.props.labelStr, className: joinClassNames(classNames.flexCol, joinClassNames(options.listDaysClass)), children: jsx(NowTimer, { unit: "day", children: (nowDate, todayRange, nowMs) => {
                    const dayNodes = [];
                    ...
                    for (let dayIndex = 0; dayIndex < segsByDay.length; dayIndex += 1) {
                        ...
                        if (daySegs) { // sparse array, so might be undefined
                            ...
                            dayNodes.push(jsx(ListDay, { dayDate: dayDate, nowDate: nowDate, nowMs: nowMs, todayRange: todayRange, segs: daySegs, isFirst: isFirst, isLast: isLast, forPrint: this.props.forPrint }, key));
                            populatedDayIndex += 1;
                        }
                    }
