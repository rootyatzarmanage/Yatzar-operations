import { RawOptionsFromRefiners, RefinedOptionsFromRefiners, EventSourceOptions, EventSourceOptionsRefined, BaseOptionsRefined, EventRefiners, BaseOptions } from '@fullcalendar/core/protected-api';
import { NativeDateFormatterOptions, FuncDateFormatterFunc, DateFormatter, DateRange, DateEnv, DateMarker, Duration, DateInput, DateTimeFormatPartWithWeek as DateTimeFormatPartWithWeek$1, DurationInput, DateRangeInput, OpenDateRange, createDuration, CmdDateFormatterFunc, WeekNumberCalculation, LocaleCodeArg } from '@full-ui/headless-calendar';
import * as react_jsx_runtime from 'react/jsx-runtime';
import * as react from 'react';
import { ReactNode, Ref, Component, CSSProperties, ComponentType, FC, RefObject, ReactElement } from 'react';
...
interface EventInstanceRange extends DateRange {
    instantStartMs?: number;
    instantEndMs?: number;
}
interface EventRangeEdge {
    marker: Date;
    instantMs?: number;
}
declare function getRangeInstantStartMs(range: EventInstanceRange, dateEnv: DateEnv): number;
declare function getRangeInstantEndMs(range: EventInstanceRange, dateEnv: DateEnv): number;
declare function buildValidInstanceRange(start: EventRangeEdge, end: EventRangeEdge, dateEnv: DateEnv): EventInstanceRange | null;
...
declare class ContentInjector<RenderProps> extends BaseComponent<ContentInjectorProps<RenderProps>> {
    private el;
    private id;
...
declare class ContentContainer<RenderProps> extends Component<ContentContainerProps<RenderProps>> {
    ...
    context: number;
    el: HTMLElement;
    InnerContent: (props: ElProps) => react.CElement<ContentInjectorProps<unknown>, ContentInjector<unknown>>;
    render(): ReactNode;
...
declare const NowIndicatorHeaderContainer: (props: NowIndicatorHeaderContainerProps) => react_jsx_runtime.JSX.Element;
...
declare const NowIndicatorLineContainer: (props: NowIndicatorLineContainerProps) => react_jsx_runtime.JSX.Element;
...
declare function getEventRangeMeta(eventRange: EventRenderRange, todayRange: DateRange, nowDate?: DateMarker, nowMs?: number): {
    isPast: boolean;
    isFuture: boolean;
    isToday: boolean;
};
...
declare function getDateSpanInstantStartMs(dateSpan: DateSpan, dateEnv: DateEnv): number;
declare function getDateSpanInstantEndMs(dateSpan: DateSpan, dateEnv: DateEnv): number;
...
export { ButtonInput as $, AllowFunc as A, BusinessHoursInput as B, CalendarController as C, DateSpanInput as D, EventSourceApi as E, DayHeaderDividerInfo as F, DayCellInfo as G, DayLaneInfo as H, InlineWeekNumberInfo as I, ViewDisplayInfo as J, TableBodyInfo as K, LocaleInput as L, MountInfo as M, NowIndicatorHeaderInfo as N, OverlapFunc as O, PluginInput as P, TableHeaderInfo as Q, CalendarDisplayInfo as R, SlotLaneInfo as S, TableDisplayInfo as T, EventClickInfo as U, ViewApi as V, WillUnmountHandler as W, EventHoveringInfo as X, DateSelectInfo as Y, DateUnselectInfo as Z, ToolbarInput as _, CalendarApi as a, DateMeta as a$, ButtonGroupInfo as a0, ButtonInfo as a1, ButtonDisplay as a2, ToolbarElementInput as a3, ToolbarSectionInfo as a4, ToolbarInfo as a5, EventDisplayInfo as a6, ViewContentInfo as a7, DatesSetInfo as a8, EventAddInfo as a9, EventResizeStopInfo as aA, EventResizeDoneInfo as aB, DateClickInfo as aC, DropInfo as aD, EventReceiveInfo as aE, EventLeaveInfo as aF, Dictionary as aG, valuesIdentical as aH, ViewContext as aI, DateProfileGenerator as aJ, DateProfile as aK, Emitter as aL, DateComponent as aM, ScrollerInterface as aN, EventRangeProps as aO, EventSegUiInteractionState as aP, DateSpan as aQ, CalendarContext as aR, EventStore as aS, EventInteractionState as aT, EventUiHash as aU, SplittableProps as aV, BaseComponent as aW, ElRef as aX, ViewOptionsRefined as aY, Splitter as aZ, EventDef as a_, EventChangeInfo as aa, EventDropInfo as ab, EventRemoveInfo as ac, CustomRenderingHandler as ad, CustomRenderingStore as ae, DateSpanApi as af, DatePointApi as ag, DateSelectionApi as ah, ButtonState as ai, NavButtonState as aj, ButtonStateMap as ak, FormatterInput as al, LocaleSingularArg as am, NoEventsInfo as an, ListDayHeaderInfo as ao, ListDayHeaderInnerInfo as ap, ListDayInfo as aq, SingleMonthInfo as ar, SingleMonthHeaderInfo as as, EventSegment as at, MoreLinkAction as au, MoreLinkSimpleAction as av, MoreLinkHandler as aw, EventDragStartInfo as ax, EventDragStopInfo as ay, EventResizeStartInfo as az, EventApi as b, createFormatter as b$, Hit as b0, CalendarListenersRefined as b1, Identity as b2, identity as b3, refineProps as b4, EventDefHash as b5, EventInstanceHash as b6, EventInstanceRange as b7, EventRangeEdge as b8, buildValidInstanceRange as b9, Action as bA, CalendarContentProps as bB, CalendarInner as bC, sortEventSegs as bD, getEventRangeMeta as bE, buildEventRangeKey as bF, MinimalEventProps as bG, EventMutation as bH, Constraint as bI, setRef as bJ, getFooterScrollbarSticky as bK, getTableHeaderSticky as bL, getIsHeightAuto as bM, ScrollerSyncerInterface as bN, refineClassName as bO, refineClassNameGenerator as bP, NowIndicatorHeaderContainer as bQ, NowIndicatorLineContainer as bR, MoreLinkContainer as bS, ViewContainer as bT, CalendarApiImpl as bU, EventImpl as bV, CalendarMediaRoot as bW, computeRootClassName as bX, ContentContainer as bY, generateClassName as bZ, CustomRendering as b_, getRangeInstantStartMs as ba, getRangeInstantEndMs as bb, EventRefined as bc, parseBusinessHours as bd, OrderSpec as be, parseFieldSpecs as bf, compareByFieldSpecs as bg, flexibleCompare as bh, guid as bi, computeViewBorderless as bj, getRectCenter as bk, mergeEventStores as bl, EventUi as bm, combineEventUis as bn, createEventUi as bo, getDateMeta as bp, CalendarData as bq, CalendarDataManager as br, ViewProps as bs, computeMajorUnit as bt, isMajorUnit as bu, getDateSpanInstantStartMs as bv, getDateSpanInstantEndMs as bw, PointerDragEvent as bx, ElementDragging as by, ViewPropsTransformer as bz, EventRenderRange as c, Rect as c0, DragMetaInput as c1, CalendarOptions as d, CalendarListeners as e, ViewOptions as f, EventSourceInput as g, EventSourceFunc as h, EventSourceFuncInfo as i, EventInput as j, EventInputTransformer as k, CssDimValue as l, ConstraintInput as m, ViewComponentType as n, ClassNameInput as o, ClassNameGenerator as p, ContentGenerator as q, DidMountHandler as r, sliceEvents as s, NowIndicatorLineInfo as t, WeekNumberHeaderInfo as u, DateTimeFormatPartWithWeek as v, MoreLinkInfo$1 as w, SlotHeaderInfo as x, AllDayHeaderInfo as y, DayHeaderInfo as z };
