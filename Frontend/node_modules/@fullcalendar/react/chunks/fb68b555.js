import { I as Interaction, b as interactionSettingsToStore, i as interactionSettingsStore } from './619854e0.js';
import { Y as whenTransitionDone, Z as preventSelection, _ as preventContextMenu, $ as allowSelection, a0 as allowContextMenu, m as mapHash, a1 as isDateSpansEqual, a2 as buildRangeEdgeOutput, a3 as enableCursor, a4 as disableCursor, x as triggerDateSelect, a5 as getDateSpanInstantStartMs, a6 as getDateSpanInstantEndMs, a7 as compareNumbers, Q as buildValidInstanceRange, a8 as diffDates, H as getElEventRange, a9 as getRelevantEvents, z as EventImpl, aa as applyMutationToEventStore, n as createEmptyEventStore, a as buildEventApis, ab as addDeltaToRangeEdge, S as getRangeInstantEndMs, T as getRangeInstantStartMs } from './1b9384f3.js';
import { c as config, E as ElementDragging, i as isDateSelectionValid, a as isInteractionValid } from './a32bd821.js';
import { E as Emitter } from './e5ccc110.js';
import { c as classNames } from './f408d713.js';
import { a as applyStyle, c as computeElIsRtl, g as getAppendableRoot, b as getEventTargetViaRoot } from './300190e3.js';
import { c as computeInnerRect, a as computeRect, g as getClippingParents, p as pointInsideRect, b as constrainPoint, i as intersectRects, d as getRectCenter, e as diffPoints } from './e030f505.js';
import { rangeContainsRange, createDuration, startOfDay } from '@full-ui/headless-calendar';
...
export { FeaturefulElementDragging as F, HitDragging as H, PointerDragging as P, buildDatePointApiWithContext as b, interactionPlugin as i };
