...
var index = {
    ...
    optionDefaults: {
        ...
        dayHeaderContent: (info) => (jsxs(Fragment, { children: [info.isToday && (jsx("div", { className: "fc-forma-1EY fc-forma-n9G fc-forma-MaV fc-forma-tb8 fc-forma-Baf fc-forma-3Lc" })), info.dayNumberText && (jsx("div", { className: joinClassNames(info.isToday && "fc-forma-DIS", info.isNarrow ? "fc-forma-1Po" : "fc-forma-9ZS"), children: info.dayNumberText })), info.weekdayText && (jsx("div", { className: "fc-forma-a3B", children: info.weekdayText }))] })),
        /* Day Cell
        --------------------------------------------------------------------------------------------- */
