...
import { j as joinClassNames } from '../../chunks/e3a08dde.js';
...
var index = {
    ...
    optionDefaults: {
        ...
        rowEventBeforeContent: (info) => ((!info.isStart && !info.isNarrow) ? filledRightTriangle("fc-monarch-Pwv fc-monarch-jmT fc-monarch-jY6 fc-monarch-Mra") : jsx(Fragment, {})),
        ...
        rowEventAfterContent: (info) => ((!info.isEnd && !info.isNarrow) ? filledRightTriangle("fc-monarch-Pwv fc-monarch-asP fc-monarch-Mra") : jsx(Fragment, {})),
        ...
        dayHeaderContent: (info) => (jsxs(Fragment, { children: [info.weekdayText && (jsx("div", { className: "fc-monarch-a3B fc-monarch-XHd fc-monarch-JMv", children: info.weekdayText })), info.dayNumberText && (jsx("div", { className: joinClassNames("fc-monarch-XE0 fc-monarch-AAA fc-monarch-dl1 fc-monarch-1sP fc-monarch-XpK fc-monarch-E9P", info.isNarrow
...
function chevronDown(className) {
    return jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: "20", height: "20", viewBox: "80 -880 800 800", fill: "currentColor", children: jsx("path", { d: "M480-304 240-544l56-56 184 184 184-184 56 56-240 240Z" }) });
}
function chevronDoubleLeft(className) {
    return jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: "20", height: "20", viewBox: "80 -880 800 800", fill: "currentColor", children: jsx("path", { d: "M440-240 200-480l240-240 56 56-183 184 183 184-56 56Zm264 0L464-480l240-240 56 56-183 184 183 184-56 56Z" }) });
}
function x(className) {
    return jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: "20", height: "20", viewBox: "80 -880 800 800", fill: "currentColor", children: jsx("path", { d: "m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z" }) });
}
function filledRightTriangle(className) {
    return (jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 800 2200", preserveAspectRatio: "none", className: className, children: jsx("polygon", { points: "0,0 66,0 800,1100 66,2200 0,2200", fill: "currentColor" }) }));
}
