...
var index = {
    ...
    optionDefaults: {
        ...
        dayHeaderContent: (info) => ((info.inPopover || !info.dayNumberText || !info.isToday) ? (jsx(Fragment, { children: info.text })) : (jsx(Fragment, { children: info.textParts.map((textPart, i) => (jsx("span", { className: joinClassNames("fc-pulse-jm6", (textPart.type === "day" && info.isToday)
        ...
        dayCellTopInnerClass: (info) => joinClassNames("fc-pulse-dl1 fc-pulse-1sP fc-pulse-XpK", info.isNarrow
            ...
            : joinClassNames("fc-pulse-bCs fc-pulse-hS8", info.isNarrow
                ? "fc-pulse-148"
                : "fc-pulse-fn8")),
        dayCellTopContent: (info) => (!info.isToday ? (jsx(Fragment, { children: info.text })) : (jsx(Fragment, { children: info.textParts.map((textPart, i) => (jsx("span", { className: joinClassNames("fc-pulse-jm6", (textPart.type === "day" && info.isToday)
...
function chevronDown(className) {
    return jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: className, width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: jsx("polyline", { points: "6 9 12 15 18 9" }) });
}
